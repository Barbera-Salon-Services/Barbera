...
public interface JsonPlaceHolderApi2 {
    ...
    @GET("gettypes/{gender}")
    Call<TypeList> getTypes(@Path ("gender") String gender, @Header("token") String token);

    @POST("getsubtypes/{gender}")
    Call<TypeList> getSubTypes(@Path ("gender") String gender,@Body ServiceItem service,@Header("token") String token);

    @POST("getallserv/{gender}")
    Call<ServiceList> getAllServices(@Path ("gender") String gender,@Body ServiceItem service, @Header("token") String token);
}
