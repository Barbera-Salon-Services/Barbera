...
public class ServiceType extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialogView = findViewById(R.id.progress_dialog_view);
...
//
//                    }
                        serviceTypeAdapter = new ServiceTypeAdapter(ServiceType.this, serviceList, salontype, progressDialogView);
