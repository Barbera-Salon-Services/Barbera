...
public class MehendiAdapter extends BaseAdapter{
        private List<Service> serviceList;
        private Context con;

    public MehendiAdapter(Context context,List<Service> serviceList) {
            con=context;
        ...
        /*  Glide.with(view.getContext()).load(serviceList.get(position).getImageId())
           .apply(new RequestOptions().placeholder(R.drawable.logo)).into(logo);*/
            if(serviceList.get(position).getTime()==null){
                timeImage.setVisibility(android.view.View.GONE);
                time.setVisibility(android.view.View.GONE);
            }
